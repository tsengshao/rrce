...
***  check max value **
  'set z 'sfidz
  'define ws=mag(u.2(z='sfidz'), v.2(z='sfidz'))'
...
'set strsiz 0.2'
'draw string 8.55 8.0 WindSpeed'
'draw string 8.55 7.65 [m/s]'

'set arrscl 0.5 5'
'set arrlab off'
'set ccolor 1'
*'d skip(maskout(u.2(z='sfidz'),ws-0.5),5);v.2(z='sfidz')'
*rc = arrow(8-0.25,0.5+0.2,0.5,5)

if ( drawsf="TRUE" )
  'set lwid 50 2'
  'set cthick 50'
  c='(0,0,0)'
  'color 1 25 1 -gxout contour -kind 'c'->'c''
  'set clab masked'
  'd sf*1e-5'
