...
********** center info **********
""")
fout.write(f"{'ts':>{width}s} {'mean':>{width}s} {'max':>{width}s} {'parea_ratio[%]':>{width}s} {'center_locx':>{width}s} {'center_locy':>{width}s} {'max_locx':>{width}s} {'max_locy':>{width}s} {'posi_mean':>{width}s}\n")
