...
'set cthick 55'
'legend br 'nexp' 10 55 'expList' 'lcList''
...
'draw string 1.2 7.65 std. of CWV'

'gxprint 'outPath'/'hashtag'cwv_std.png x1600 y1200'
'gxprint 'outPath'/white/'hashtag'cwv_std.png x1600 y1200 white'
